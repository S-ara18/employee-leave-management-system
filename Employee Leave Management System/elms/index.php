...
<html lang="en">
    ...
    .mn-inner{
        height: 100%;
      width: 100%;
      background-image: url("./assets/images/webchat.jpg");
    }
    .page-title{
    float: none;
    display: block;
    ...
    .card-content{
    position: relative;
    /*background-image: url("./assets/images/web5.jpg");*/
    background: #D4EFDF;
...
.page-title{
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
          ...
          <div class="footer">
                    <p class="copyright"><a href="https://www.instagram.com/techorix_projects">Employee Leave Management System </a> © </p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Welcome to ELMS</h4></div>
